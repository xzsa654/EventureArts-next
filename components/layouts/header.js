...
export default function LayoutsHeader(props) {
  return (
    <>
        ...
        <div class="flex flex-wrap items-center gap-4 px-10 py-4 relative bg-white min-h-[70px]">
          ...
          >
            ...
            <div class="lg:flex max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
              <ul class="lg:flex lg:gap-x-8 max-lg:space-y-2">
                ...
                <li class="max-lg:border-b max-lg:py-3">
                  <a
                    ...
                    class="hover:text-[#007bff] font-semibold text-[#007bff] block text-[15px]"
                  >
                    Home
                  </a>
                </li>
                <li class="max-lg:border-b max-lg:py-3">
                  <a
                    href="javascript:void(0)"
                    class="hover:text-[#007bff] font-semibold text-[#333] block text-[15px]"
                  >
                    Team
                  </a>
                </li>
                ...
                <li class="text-[15px] max-lg:border-b max-lg:py-3">
                  <a
                    href="javascript:void(0)"
                    class="hover:text-[#007bff] font-semibold text-[#333] block text-[15px]"
                  >
              ...
              <a
                href="javascript:void(0)"
                class="m-auto absolute lg:left-2/4 lg:top-1/4 lg:-translate-x-1/2 max-lg:hidden"
              >
                <img
                  src="https://readymadeui.com/readymadeui.svg"
                  alt="logo"
