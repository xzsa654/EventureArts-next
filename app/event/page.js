...
export default function Event(props) {
  ...
  // Q&A 預設內容
  const defaultContent = <p>這是預設內容，您可以在這裡提供問題解答或其他資訊。</p>;
          ...
          <div className="flex flex-row w-full justify-evenly items-center h-2/3">
            ...
            <div className="Special h-[70%] flex flex-col items-center">
              ...
              <div className="2title gap-2 flex flex-col text-center justify-between">
                ...
                <p className='subtitle h-[50%]'>包含多家跨國品牌、中小企業主與個人創作者等。</p>
              </div>
            </div>
            ...
            <div className="Special h-[70%] flex flex-col items-center">
              ...
              <div className="2title gap-2 flex flex-col text-center justify-between">
                ...
                <p className='subtitle h-[50%]'>新會員持續增長，精準分眾推播，提升網站活躍度。</p>
              </div>
            </div>
            ...
            <div className="Special h-[70%] flex flex-col items-center">
              ...
              <div className="2title gap-2 flex flex-col text-center justify-between">
                ...
                <p className='subtitle h-[50%]'>聚集高收入、高學習力、重視生活風格的活動愛好者。</p>
              </div>
            </div>
          </div>
        </div> 
        ...
        <div className="section4 h-screen flex flex-col justify-center px-16">
          ...
          <div className="accordion h-[80%] w-full">
            <HerouiAccordion variant="light" defaultExpandedKeys={["1"]} >
              ...
              title={<span className="why">為什麼要將我的品牌加入EventureArts?</span>}>{defaultContent}
              </HerouiAccordionItem>
              <HerouiAccordionItem key="2" className="pb-4" aria-label="問題2" 
              title={<span className="why">如何加入EventureArts？</span>}>{defaultContent}
              </HerouiAccordionItem>
              <HerouiAccordionItem key="3" className="pb-4" aria-label="問題3" 
              title={<span className="why">如何加入EventureArts？</span>}>{defaultContent}
              </HerouiAccordionItem>              
              <HerouiAccordionItem key="4" className="pb-4" aria-label="問題4" 
              title={<span className="why">如何在EventureArts上架課程或展覽？</span>}>{defaultContent}
              </HerouiAccordionItem>
              <HerouiAccordionItem key="5" className="pb-4" aria-label="問題5" 
              title={<span className="why">如何選擇場地？</span>}>{defaultContent}
              </HerouiAccordionItem>
              <HerouiAccordionItem key="6" className="pb-4" aria-label="問題6" 
              title={<span className="why">如何核銷用戶購買的課程或展覽票券？</span>}>{defaultContent}
              </HerouiAccordionItem>
            </HerouiAccordion>
          </div>
        </div>
