  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        {/* courseButton start */}
        <Link href="/course" className={`${styles.courseButton} ${styles.btn}`}>
          <div className="h-[178px] flex-col justify-start items-start gap-2 inline-flex">
            <div data-svg-wrapper>
              ...
              >
                <path d="M36.5887 20L22.6615 21.1656L28.7305 28.7305L21.1656 22.6615L20 36.5887L18.7342 22.6986L0 40L17.3014 21.2658L3.41128 20L17.3348 18.8344L11.2695 11.2695L18.8344 17.3385L20 3.41128L21.2621 17.3088L40 0L22.6949 18.7342L36.5887 20Z" />
              </svg>
            </div>
        ...
        {/* eventButton start */}
        <Link href="/event" className={`${styles.eventButton} ${styles.btn}`}>
        ...
        <Link
          href="/exhibit"
          className={`${styles.exhibitButton} ${styles.btn}`}
        >
          <div className="h-[184.71px] flex-col justify-start items-start gap-2 inline-flex">
            <div data-svg-wrapper>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M0 23.3571C15 23.3571 15 6.86975 15 0C15 6.86975 15 23.3571 30 23.3571C15 23.3571 15 40.7605 15 46.7143C15 40.7605 15 23.3571 0 23.3571Z" />
              </svg>
            </div>
            <div className="  text-xl font-sans font-semibold tracking-[2.48px]">
              (33,160)
        ...
        {/* mapButton start */}
        <Link href="/map" className={`${styles.mapButton} ${styles.btn}`}>
