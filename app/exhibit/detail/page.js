...
export default function ExhibitionDetail() {
  ...
  React.useEffect(() => {
    fetchExhibitionDetails().then(setExhibitionData)
  }, [])
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 pt-6">
                <a href="#" className="text-xl font-bold flex-1 py-3 px-4 flex items-center justify-center text-black hover:underline">
