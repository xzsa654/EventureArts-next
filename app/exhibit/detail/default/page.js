...
const fetchExhibitionDetails = async (e_id) => {
  ...
  return {
    e_id,
    e_name: "This is a default page of exhibition detail. 畢卡索",
    e_abstract:
    ...
    e_desc:
      "This is a default view when no specific exhibition is selected.This is a default view when no specific exhibition is selected.This is a default view when no specific exhibition is selected.This is a default view when no specific exhibition is selected.This is a default view when no specific exhibition is selected.這是會上下滑動的區域, 藉由直線, 相鄰直線上下方向相反現年96歲的草間彌生是當代藝術史上最具代表性及親覽性的創作者之一。她的作品涉及繪畫、雕塑、拼貼、版畫、行為展演等多領域, 並以其鮮豔的色彩和圓點圖案聞名。本展將展出1951年至2005年間的70件作品, 並緊焦於草間彌生藝術生涯的關鍵時期和創作探索。",
