...
export default function OnlineExhibitions({e_id}) {
  ...
  if (error) return <div className="text-white">Error loading online exhibitions</div>
          ...
          >
              ...
              <div className="p-4 border border-white/30 rounded-lg advanced-search">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Dropdown>
                    ...
                    <DropdownMenu aria-label="Exhibition Type" onAction={(key) => setExType(key)}>
                  ...
                  <Dropdown>
                    ...
                    <DropdownMenu aria-label="Date" onAction={(key) => setDateRange(key)}>
            ...
            <div className="flex justify-end mb-6">
              <Dropdown>
                ...
                <DropdownMenu aria-label="Sort By" onAction={(key) => setSortOption(key)}>
              ...
              {exhibitions?.data?.map((exhibition) => (
                ...
                >
                  <OnlineExhibitionCard
                    ...
                    description={exhibition.e_abstract || exhibition.e_desc}
                    thumbnail={exhibition.e_img || "/chu-images/img_9.jpg"}
                    type={exhibition.exhibition_form}
                    artist={exhibition.creator_name || "Unknown Artist"}
